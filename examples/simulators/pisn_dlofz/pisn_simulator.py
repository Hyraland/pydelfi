...
class PISN_Model():
    ...
    def __init__(self, pisn_data_path = '/Users/hyraland/Projects/GW/Cosmology/PISNLineCosmography/'):
        ...
        self.data = np.mean(pisn_data['dl'],axis = 1) # pisn_data['dl_z'] # np.mean(pisn_data['dl'],axis = 1)
        delta_m_cut = 10
        self.auxiliary_data = np.column_stack([pisn_data['z']])
